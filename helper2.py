...
def quantization_knowledge_distillation(
    ...
    loss_csv_file = f'{kd_loss}_{alpha_s:.1f}_{alpha_t:.1f}_{num_epochs_selfstudying}-{num_epochs_costudying}-{num_epochs_tutoring}_{datetime.now().strftime("%H%M%S")}_{dataset}.csv'
