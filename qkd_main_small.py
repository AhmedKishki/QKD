...
def train_quantized_student_with_teacher(
    ...
    """
    csv_filename = os.path.join(cwd, "results_qkd_small.csv")
...
def main():
    ...
    alpha_st_pairs = [(0.5,0.5),(1.0,0.5),(0.7,0.3),(1.0,0.3)]
    temperatures = [6.0]
    num_epochs = [(5,5,5),(10,5,5),(5,5,10),(5,10,5),(0,10,10),(10,10,0),(0,20,0)]
    max_lr = 1e-3
    min_lr = 1e-6
    teacher_lr = 1e-6
